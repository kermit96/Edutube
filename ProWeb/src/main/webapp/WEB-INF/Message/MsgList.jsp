...
<script>
	$(document).ready(function() {
		$("#smsg").click(function(){
			window.open("../Message/MsgSeList.do?id=${sessionScope.ID}", "Edutube2","width=270, height=260, resizable=no, scrollbars=yes");
	...
	function showDetail(no) {
		window.open("../Message/MsgView.do?no=" + no, "Edutube2","width=270, height=260, resizable=no");
	}
</script>
...
<body style='overflow-X:hidden'>
	...
	<div id='EduContainer'>
		...
		<div id="Main">
			...
			<input type="hidden" id="toid" name="toid" value="${sessionScope.ID}">
...
<!-- 
 ...
 -->
					...
					<tr>
						<td colspan="3" align="center"><input type="button" value="보낸메일함으로" id="smsg">
						</td>
					</tr>
