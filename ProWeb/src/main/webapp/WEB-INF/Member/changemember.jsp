		...
		try {
			...
			$.ajax({
				...
				success : function(data) {
					...
					if (data.result) {
						$("#checknickname").html(
								"${LANGDATA.memberchecknickfail}");
						$("#mem_nick").focus();
					} else {
						$("#checknickname").html(
								"${LANGDATA.memberchecknicksuccess}");
					}
				},
					...
					<div class="tab-content">
						<div id="changeuserinfo" class="tab-pane fade in active">
							...
							<table>
								<tr>
									...
									<td><input type="text" id="mem_nick"
								...
								<tr>
									...
									<td><input type="text" id="mem_tel"
										value="${member.mem_tel}"></td>
								</tr>
								...
								<tr>
									...
									<td><input type="text" id="mem_addrCode"
										...
										type="text" id="mem_addr" name="mem_addr" id="mem_addr"
										value="${member.mem_addr}"
										placeholder="${LANGDATA.member_addr}"> <input
										type="text" id="mem_detailaddr" name="mem_detailaddr"
										id="mem_detailaddr" value="${member.mem_detailaddr}"
										placeholder="${LANGDATA.member_addrmore}"></td>

								</tr>

								<tr>
									<td colspan="2"><button id="changemember">${LANGDATA.member_change}
										</button></td>
								</tr>
							</table>
						...
						<div id="changepassword" class="tab-pane fade">
							...
							<table>
								...
								<tr>
									<td colspan="2"><button id="changepasswordbutton">${LANGDATA.member_change}
										</button></td>
								</tr>
							</table>
						</div>
