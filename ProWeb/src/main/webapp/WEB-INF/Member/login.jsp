      ...
      <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your session</p>
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              <button class="btn btn-primary btn-block btn-flat" id="login">Sign In</button>
            </div><!-- /.col -->
          </div>
             

        <a href="JavaScript:findmember()" id="findmember">I forgot my password</a><br>
        <a href="JavaScript:make()" class="text-center" id="makeid">Register a new membership</a>
