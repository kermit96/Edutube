...
public class SeedCipher {
	...
	public byte[] encrypt(String inData, String szKey, String charset)
			throws UnsupportedEncodingException {
		return encrypt(inData.getBytes(charset), szKey.getBytes("UTF-8"));
	}

	public String encryptAsString(String inData, String szKey)
			throws UnsupportedEncodingException {
		return new String(encrypt(inData.getBytes("UTF-8"), szKey.getBytes("UTF-8")),"UTF-8");
	}
	...
	public String decryptAsString(String encryptString, String szKey)  throws UnsupportedEncodingException {

		return new String(decrypt(encryptString.getBytes("UTF-8"), szKey.getBytes("UTF-8")),"UTF-8");		
	}

	
	public String decryptAsString(String encryptString, String szKey,String charset)  throws UnsupportedEncodingException {

		return new String(decrypt(encryptString.getBytes(charset), szKey.getBytes()));		
	}
