...
//			KC0 = golden ratio; KCi = ROTL(KCi-1, 1) 	
	...
	// reorder for little endian	  
		...
		public static String encrypt(String normalStr)
		{
			...
			return encrypt(normalStr,DEFAULT_IV);
		}
		
		public static String encrypt(String normalStr,String key)
		{
			try {
			int[] seedKey = getSeedRoundKey(key);
						
			
			String encStr = getSeedEncrypt(normalStr, seedKey);
		...
		public static String decrypt(String encStr,String key)
		{
			try {
				int[] seedKey = getSeedRoundKey(key);
				String decStr = getSeedDecrypt(encStr, seedKey);
				return decStr;
			} catch (Exception ex)
			{
		...
		public static String decrypt(String encStr)
		{
			...
			return decrypt(encStr,DEFAULT_IV);
...
//			// 암복호화에 사용할 키 배열생성
			...
			/*
			String encStr = getSeedEncrypt(nomalStr, seedKey);
