...
import com.wing.mainApp.sql.DBTYPE;
...
public class Globalconfig {
    ...
    private int    encryptedmethod; // 0 : ¾øÀ½ 1: tls 2: ssl   
	...
	public void setPassword(String password) {
		...
		try {
			handler.setValue("password",		com.wing.mainApp.util.ase256.AES_Encode(password));
	...
	public Globalconfig(String filename)
	{
		...
		if (userid == null)
		 ...
		 try {
			password =   com.wing.mainApp.util.ase256.AES_Decode( handler.getValue("password"));
